...
#This script requires from the user 3 inputs:
	#1) Data must be in data frame format with 3 columns corresponding to region, position, and fst value. Order data frame on ascending on position
		#	       chr1 156 0.00070403
		#	       chr1 203 0.00008735
		#					...
...
creeper<-function(fst.frame, window.size = window.size ){
